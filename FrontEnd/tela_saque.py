...
# Form implementation generated from reading ui file 'tela-saque.ui'
#
...
class Ui_Tela_Saque(object):
    def setupUi(self, Tela_Saque):
        ...
        Tela_Saque.resize(340, 340)
        Tela_Saque.setMinimumSize(QtCore.QSize(340, 340))
        Tela_Saque.setMaximumSize(QtCore.QSize(340, 340))
        Tela_Saque.setStyleSheet("QFrame {\n"
"    color: rgb(40, 40, 40)\n"
"}")
...
"}")
        ...
        self.pushButton_Sacar = QtWidgets.QPushButton(self.frame)
        self.pushButton_Sacar.setGeometry(QtCore.QRect(120, 250, 100, 40))
        self.pushButton_Sacar.setMinimumSize(QtCore.QSize(100, 30))
        self.pushButton_Sacar.setMaximumSize(QtCore.QSize(100, 40))
        font = QtGui.QFont()
        font.setFamily("Unispace")
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.labelSaldo.setGeometry(QtCore.QRect(10, 100, 81, 40))
...
"}")
        ...
        self.lineEdit_Saldo.setGeometry(QtCore.QRect(90, 100, 200, 40))
...
"}")
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(0, 180, 341, 51))
...
"}")
    ...
    def retranslateUi(self, Tela_Saque):
        ...
        Tela_Saque.setWindowTitle(_translate("Tela_Saque", "V&V Saque"))
        self.labelBanco.setText(_translate("Tela_Saque", "V&V Bank"))
        self.pushButton_Voltar.setText(_translate("Tela_Saque", "Voltar"))
        self.pushButton_Sacar.setText(_translate("Tela_Saque", "Sacar"))
        self.labelLogin.setText(_translate("Tela_Saque", "Saque"))
        self.labelSaldo.setText(_translate("Tela_Saque", "Saldo: R$"))
        self.lineEdit_Saldo.setPlaceholderText(_translate("Tela_Saque", "100.00"))
        self.lineEdit_Valor.setPlaceholderText(_translate("Tela_Saque", "R$"))
        self.lineEdit_Senha.setPlaceholderText(_translate("Tela_Saque", "SENHA"))
